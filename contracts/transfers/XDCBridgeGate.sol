    ...
    IXDCBridgeGate
{
    ...
    address public xdcBridgeTokenDeployer;
    ...
    function deployNewAsset(
        ...
        address xdcBridgeTokenAddress = IXDCBridgeTokenDeployer(xdcBridgeTokenDeployer)
            .deployAsset(xbridgeId, _name, _symbol, _decimals);

        _addAsset(xbridgeId, xdcBridgeTokenAddress, _nativeTokenAddress, _nativeChainId);
    }
    ...
    /// @param _xdcBridgeTokenDeployer Asset deployer address.
    function setXDCBridgeTokenDeployer(address _xdcBridgeTokenDeployer) external onlyAdmin {
        xdcBridgeTokenDeployer = _xdcBridgeTokenDeployer;
    }
