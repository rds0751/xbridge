...
abstract contract BridgeAppBase is Initializable, AccessControlUpgradeable, PausableUpgradeable {
    ...
    modifier onlyControllingAddress() {
        ICallProxy callProxy = ICallProxy(xdcBridgeGate.callProxy());
    ...
    function __BridgeAppBase_init(IXDCBridgeGate _xdcBridgeGate) internal initializer {
        __Context_init_unchained();
        __ERC165_init_unchained();
        __AccessControl_init_unchained();
        __Pausable_init_unchained();
        __BridgeAppBase_init_unchained(_xdcBridgeGate);
    }

    function __BridgeAppBase_init_unchained(IXDCBridgeGate _xdcBridgeGate) internal initializer {
