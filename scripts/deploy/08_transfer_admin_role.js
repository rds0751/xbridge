...
module.exports = async function({getNamedAccounts, deployments, network}) {
  ...
  // const multisig = deployInitParams.xdcBridgeTokenAdmin;
  ...
  // await transferAdminRole(xdcBridgeTokenDeployer, "XDCBridgeTokenDeployer");
  ...
  // await transferAdminRole(xdcBridgeGate, "XDCBridgeGate");
