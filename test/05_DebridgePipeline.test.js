...
contract("XDCBridgeGate real pipeline mode", function () {
  before(async function () {
    ...
    this.xdcBridgeTokenETH = await XDCBridgeTokenFactory.deploy();
    this.xdcBridgeTokenBSC = await XDCBridgeTokenFactory.deploy();
    this.xdcBridgeTokenHECO = await XDCBridgeTokenFactory.deploy();

    // deploy XDCBridgeTokenDeployer contracts
    this.xdcBridgeTokenDeployerETH = await upgrades.deployProxy(
      XDCBridgeTokenDeployerFactory,
      [
        this.xdcBridgeTokenETH.address,
        alice,
        ZERO_ADDRESS,
      ]);
    this.xdcBridgeTokenDeployerBSC = await upgrades.deployProxy(
      XDCBridgeTokenDeployerFactory,
      [
        this.xdcBridgeTokenBSC.address,
        alice,
        ZERO_ADDRESS,
      ]);
    this.xdcBridgeTokenDeployerHECO = await upgrades.deployProxy(
      XDCBridgeTokenDeployerFactory,
      [
        this.xdcBridgeTokenHECO.address,
        alice,
        ZERO_ADDRESS,
      ]);
    ...
    this.xbridgeETH = await upgrades.deployProxy(
      ...
      [
        ...
        this.xdcBridgeTokenDeployerETH.address,
    ...
    this.xbridgeBSC = await upgrades.deployProxy(
      ...
      [
        ...
        this.xdcBridgeTokenDeployerBSC.address,
        ZERO_ADDRESS,
    ...
    this.xbridgeHECO = await upgrades.deployProxy(
      ...
      [
        ...
        this.xdcBridgeTokenDeployerHECO.address,
        ZERO_ADDRESS,
    ...
    // set xbridge address
    await this.xdcBridgeTokenDeployerETH.setXbridgeAddress(this.xbridgeETH.address);
    await this.xdcBridgeTokenDeployerBSC.setXbridgeAddress(this.xbridgeBSC.address);
    await this.xdcBridgeTokenDeployerHECO.setXbridgeAddress(this.xbridgeHECO.address);
    ...
    await this.callProxy.grantRole(xdcBridge_GATE_ROLE, this.xbridgeETH.address);
    await this.callProxy.grantRole(xdcBridge_GATE_ROLE, this.xbridgeBSC.address);
    await this.callProxy.grantRole(xdcBridge_GATE_ROLE, this.xbridgeHECO.address);
  ...
  context("Test managing assets", () => {
    ...
    it("should deploy list of new assets", async function () {
      ...
      await this.xdcBridgeTokenDeployerBSC.setOverridedTokenInfo(
        [xbridgeId],
        [
          {
            accept: true,
      ...
      assert.equal( await deEmptyNameToken.name(), "xdcBridge NONAME");
      ...
      const xdcBridgeTokenInstance = await XDCBridgeToken.at(deWethTokenAddress);
      // console.log(deWethTokenAddress);
      // console.log(await xdcBridgeTokenInstance.symbol());
      // console.log(await xdcBridgeTokenInstance.name());
      // console.log(await xdcBridgeTokenInstance.decimals());
      assert.equal( await xdcBridgeTokenInstance.symbol(), "deETH");
      assert.equal( await xdcBridgeTokenInstance.name(), "xdcBridge ETH");
      assert.equal( (await xdcBridgeTokenInstance.decimals()).toString(), "18");
      ...
      assert.equal( await deBNBInHecoTokenInstance.name(), "xdcBridge Wrapped BNB");
  ...
  context("Test mint method (BSC network)", () => {
    ...
    it("should mint (deETH) when the submission is approved", async function () {
      ...
      const xdcBridgeToken = await XDCBridgeToken.at(xbridgeInfo.tokenAddress);
    ...
    it("should mint (deLink) when the submission is approved ", async function () {
      ...
      const xdcBridgeToken = await XDCBridgeToken.at(xbridgeInfo.tokenAddress);
      const newBalance = toBN(await xdcBridgeToken.balanceOf(this.linkSubmission.args.receiver));
      const submissionId = await this.xbridgeBSC.getSubmissionId(
        this.linkXbridgeId,
        ethChainId,
        bscChainId,
  ...
  discountsValues.forEach(discount => {
    context(`Test burn method (BSC network) discount: ${(discount * 100) / BPS}%`, () => {
      ...
      it("should support non EVM receiver parameter", async function () {
        ...
        const xdcBridgeToken = await XDCBridgeToken.at(xbridgeInfo.tokenAddress);
        // console.log(`xdcBridgeToken: ${xdcBridgeToken.address}`);
        // console.log(`currentToken: ${currentToken}`);
        assert.equal(currentToken, xdcBridgeToken.address);
  ...
  context(`Test transfer between BSC to HECO.`, () => {
    ...
    it("should mint (deBSC) when the submission is approved", async function () {
      ...
      const xdcBridgeToken = await XDCBridgeToken.at(xbridgeInfo.tokenAddress);
      const newBalance = toBN(await xdcBridgeToken.balanceOf(this.nativeSubmission.args.receiver));
    ...
    it("should mint (deCake) when the submission is approved ", async function () {
      ...
      const xdcBridgeToken = await XDCBridgeToken.at(xbridgeInfo.tokenAddress);
      const newBalance = toBN(await xdcBridgeToken.balanceOf(this.cakeSubmission.args.receiver));
      const submissionId = await this.xbridgeHECO.getSubmissionId(
        this.cakeXbridgeId,
        bscChainId,
        hecoChainId,
