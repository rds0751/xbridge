...
describe("DefiController", function () {
  ...
  describe.skip("with xbridgeGate", function () {
    ...
    it("xdcBridgeGate is correct", async function () {
      expect(this.xbridge.address).to.be.equal(await this.defiController.xdcBridgeGate());
    });
      ...
      describe("with strategy (inactive)", function () {
        ...
        describe("then add stakeToken and native strategies", function () {
          ...
          describe("mint stakeToken and send native eth on xbridge", function () {
            ...
            describe("add bridges & connect xdcBridgeGate", function () {
              const chainId = 1;
              const maxAmount = 0;
