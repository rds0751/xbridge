...
describe("CallProxy", function () {
  ...
  beforeEach(async function () {
    ...
    const xdcBridge_GATE_ROLE = await this.proxy.xdcBridge_GATE_ROLE();
    await this.proxy.grantRole(xdcBridge_GATE_ROLE, deployer.address);
  });
  ...
  describe("Cross-contract interaction", function () {
    ...
    beforeEach(async function () {
      ...
      const xdcBridge_GATE_ROLE = await this.proxy.xdcBridge_GATE_ROLE();
      await this.proxy.grantRole(xdcBridge_GATE_ROLE, this.ProxyConsumer.address);
    });
