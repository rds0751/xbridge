...
const xdcBridgeGateFrom = new web3From.eth.Contract(
...
const xdcBridgeGateTo = new web3To.eth.Contract(
    XDCBridgeGateJson.abi as AbiItem[],
    xdcBridgeGATE_ADDRESS
) as unknown as XDCBridgeGate;
...
async function main() {
    ...
    const tsSendArguments: TsSendArguments = {
        ...
        xbridgeGateInstance: xdcBridgeGateFrom,
        xbridgeGateAddress: xdcBridgeGATE_ADDRESS,
